...
const questionTemplate = (questionNum) => {
  ...
  return  `
    ...
    <fieldset name='answers'>
      ...
      <label id='flex-label'>
        <input type="radio" id="2" name="answers" value=${data[questionNum].answer2}>
...
//     return answerInput = document.getElementById('1').value;
//     case document.getElementById('2').checked:
//     return answerInput = document.getElementById('2').value;
//   }
//
//   if (document.getElementById('1').checked) {
//     answerInput = document.getElementById('1').value;
